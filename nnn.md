...
היתרון: כל שדה שנוסף ל-Atlas Dashboard — רואים אותו ב-real time. כשהחבר שלכם מגיש תוצאה, היא מופיעה מיד ב-Browse Collections.k
...
Setup Atlas
צרו cluster M0 Free ב-cloud.mongodb.com
הוסיפו משתמש ב-Database Access
פתחו רשת ל-0.0.0.0/0 ב-Network Access
קבלו connection string והכניסו ל-.env:
...
String
✓
שם המשחק (tetris / snake / space-invaders)
points
Number
✓
ניקוד, לא יכול להיות שלילי
level
Number
...
—
—
createdAt ו-updatedAt אוטומטיים
